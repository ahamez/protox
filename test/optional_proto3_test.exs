defmodule OptionalProto3Test do
  ...
  test "A proto3 optional field is encoded as a oneof" do
    ...
    decoded_msg2_as_msg1 = OptionalMsg1.decode!(encoded_msg2)
  ...
  test "A proto3 optional empty message field is encoded as a oneof" do
    ...
    decoded_msg4_as_msg3 = OptionalMsg3.decode!(encoded_msg4)
  ...
  test "Use the latest set value on the wire" do
    ...
    assert OptionalMsg3.decode!(bin1 <> bin2) == %OptionalMsg3{foo: %OptionalMsg1{foo: 100}}
    assert OptionalMsg3.decode!(bin2 <> bin1) == %OptionalMsg3{foo: %OptionalMsg1{foo: 32}}
  end
end
