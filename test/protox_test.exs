defmodule ProtoxTest do
  ...
  test "from files, with namespace" do
    assert Namespace.Proto2A.defs() == %{
      1 => {:repeated_int32_packed, :packed, :int32},
      2 => {:repeated_int32_unpacked, :unpacked, :int32},
      3 => {:optional_nested_message, {:default, nil}, {:message, Namespace.Proto2A.NestedMessage}},
      4 => {:repeated_nested_enum, :unpacked, {:enum, Namespace.Proto2A.NestedEnum}},
      5 => {:repeated_nested_message, :unpacked, {:message, Namespace.Proto2A.NestedMessage}},
      6 => {:bytes, {:default, "`v"}, :bytes},
      126 => {:extension_int32, {:default, nil}, :int32},
      199 => {:extension_double, {:default, 42.42}, :double}
    }
    ...
    assert Namespace.Proto2B.defs() == %{
      1 => {:optional_proto2a_nested_enum, {:default, nil}, {:enum, Namespace.Proto2A.NestedEnum}},
      2 => {:required_proto2a_nested_enum, {:default, :N_THREE}, {:enum, Namespace.Proto2A.NestedEnum}}
    }
    ...
    assert Namespace.Abc.Def.Proto3.defs() == %{
      ...
      4 => {:oneof_1_int32, {:oneof, :oneof_1}, :int32},
      5 => {:oneof_1_double, {:oneof, :oneof_1}, :double},
      6 => {:oneof_1_foreign_enum, {:oneof, :oneof_1}, {:enum, Namespace.Abc.Def.ForeignEnum}},
      7 => {:oneof_1_proto2a, {:oneof, :oneof_1}, {:message, Namespace.Proto2A}},
      8 => {:map_string_timestamp, :map, {:string, {:message, Namespace.Google.Protobuf.Timestamp}}},
      9 => {:bytes, {:default, ""}, :bytes},
      10 => {:map_int64_nested_enum, :map, {:int64, {:enum, Namespace.Abc.Def.Proto3.NestedEnum}}},
      134 => {:oneof_2_int32, {:oneof, :oneof_2}, :int32},
      135 => {:oneof_2_nested_enum, {:oneof, :oneof_2}, {:enum, Namespace.Abc.Def.Proto3.NestedEnum}},
      9999 => {:nested_enum, {:default, :FOO}, {:enum, Namespace.Abc.Def.Proto3.NestedEnum}}
    }
  end
