defmodule Protox.DecodeTest do
  ...
  test "Sub.h" do
    bytes = <<18, 0, 48, 0, 56, 0, 64, 0, 72, 0, 106, 8, 0, 0, 0, 0, 0, 0, 0, 0, 114, 4,
              255, 255, 255, 255, 122, 16, 154, 153, 153, 153, 153, 153, 64, 64, 0, 0, 0, 0,
              0, 0, 70, 192, 136, 241, 4, 0>>
    assert Sub.decode(bytes) ==\
  ...
  test "Msg.j" do
    ...
    assert Msg.decode(bytes) ==\
           %Msg{d: :FOO, e: false, f: nil, g: [], h: 0.0, i: [], j: [%Sub{a: 786}, %Sub{b: "foo"}],
                k: %{}}
  end
