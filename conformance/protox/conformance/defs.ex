  ...
  use Protox.Define,
    ...
    messages: [
      ...
      },
      {
        ...
        :proto2,
        [
          {1, :optional, :a, {:default, nil}, :int32},
          {2, :optional, :corecursive, {:default, nil},
      ...
      },
      {
        ...
        :proto2,
        [
          {1, :optional, :c, {:default, nil}, :int32}
        ]
      },
      {
        ...
        :proto2,
        [
          {1, :optional, :optional_int32, {:default, nil}, :int32},
          {2, :optional, :optional_int64, {:default, nil}, :int64},
          {3, :optional, :optional_uint32, {:default, nil}, :uint32},
          {4, :optional, :optional_uint64, {:default, nil}, :uint64},
          {5, :optional, :optional_sint32, {:default, nil}, :sint32},
          {6, :optional, :optional_sint64, {:default, nil}, :sint64},
          {7, :optional, :optional_fixed32, {:default, nil}, :fixed32},
          {8, :optional, :optional_fixed64, {:default, nil}, :fixed64},
          {9, :optional, :optional_sfixed32, {:default, nil}, :sfixed32},
          {10, :optional, :optional_sfixed64, {:default, nil}, :sfixed64},
          {11, :optional, :optional_float, {:default, nil}, :float},
          {12, :optional, :optional_double, {:default, nil}, :double},
          {13, :optional, :optional_bool, {:default, nil}, :bool},
          {14, :optional, :optional_string, {:default, ""}, :string},
          {15, :optional, :optional_bytes, {:default, <<>>}, :bytes},
          {18, :optional, :optional_nested_message, {:default, nil},
           {:message, Protox.ProtobufTestMessages.Proto2.NestedMessage}},
          {19, :optional, :optional_foreign_message, {:default, nil},
           {:message, Protox.ProtobufTestMessages.Proto2.ForeignMessage}},
          {21, :optional, :optional_nested_enum, {:default, :FOO},
           {:enum, Protox.ProtobufTestMessages.Proto2.NestedEnum}},
          {22, :optional, :optional_foreign_enum, {:default, :FOREIGN_FOO},
           {:enum, Protox.ProtobufTestMessages.Proto2.ForeignEnum}},
          {24, :optional, :optional_string_piece, {:default, ""}, :string},
          {25, :optional, :optional_cord, {:default, ""}, :string},
          {27, :optional, :recursive_message, {:default, nil},
           {:message, Protox.ProtobufTestMessages.Proto2.TestAllTypesProto2}},
          ...
          {56, :optional, :map_int32_int32, :map, {:int32, :int32}},
          {57, :optional, :map_int64_int64, :map, {:int64, :int64}},
          {58, :optional, :map_uint32_uint32, :map, {:uint32, :uint32}},
          {59, :optional, :map_uint64_uint64, :map, {:uint64, :uint64}},
          {60, :optional, :map_sint32_sint32, :map, {:sint32, :int32}},
          {61, :optional, :map_sint64_sint64, :map, {:sint64, :int64}},
          {62, :optional, :map_fixed32_fixed32, :map, {:fixed32, :fixed32}},
          {63, :optional, :map_fixed64_fixed64, :map, {:fixed64, :fixed64}},
          {64, :optional, :map_sfixed32_sfixed32, :map, {:sfixed32, :sfixed32}},
          {65, :optional, :map_sfixed64_sfixed64, :map, {:sfixed64, :sfixed64}},
          {66, :optional, :map_int32_float, :map, {:int32, :float}},
          {67, :optional, :map_int32_double, :map, {:int32, :double}},
          {68, :optional, :map_bool_bool, :map, {:bool, :bool}},
          {69, :optional, :map_string_string, :map, {:string, :string}},
          {70, :optional, :map_string_bytes, :map, {:string, :bytes}},
          {71, :optional, :map_string_nested_message, :map,
           {:string, {:message, Protox.ProtobufTestMessages.Proto2.NestedMessage}}},
          {72, :optional, :map_string_foreign_message, :map,
           {:string, {:message, Protox.ProtobufTestMessages.Proto2.ForeignMessage}}},
          {73, :optional, :map_string_nested_enum, :map,
           {:string, {:enum, Protox.ProtobufTestMessages.Proto2.NestedEnum}}},
          {74, :optional, :map_string_foreign_enum, :map,
          ...
          {102, :repeated, :unpacked_nested_enum, :unpacked,
           {:enum, Protox.ProtobufTestMessages.Proto2.NestedEnum}},
          {111, :optional, :oneof_uint32, {:oneof, :oneof_field}, :uint32},
          {112, :optional, :oneof_nested_message, {:oneof, :oneof_field},
           {:message, Protox.ProtobufTestMessages.Proto2.NestedMessage}},
          {113, :optional, :oneof_string, {:oneof, :oneof_field}, :string},
          {114, :optional, :oneof_bytes, {:oneof, :oneof_field}, :bytes},
          {115, :optional, :oneof_bool, {:oneof, :oneof_field}, :bool},
          {116, :optional, :oneof_uint64, {:oneof, :oneof_field}, :uint64},
          {117, :optional, :oneof_float, {:oneof, :oneof_field}, :float},
          {118, :optional, :oneof_double, {:oneof, :oneof_field}, :double},
          {119, :optional, :oneof_enum, {:oneof, :oneof_field},
           {:enum, Protox.ProtobufTestMessages.Proto2.NestedEnum}}
        ]
      },
      {
