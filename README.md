...
You can alternatively launch these conformance tests with `mix test` by including the `conformance` tag:
  ```
  MIX_ENV=test mix test --include conformance
  ```
